        ...
        while (true) {
            ...
            switch (sc.nextInt()) {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    System.out.println("números impares comprendidos entre el 0 y 100");
                    ejercicio9();
                    break;
                case 10:
                        ...
                        try {
                            ...
                            if (bol != 1) {
                                if (men > 0 && may == 0) {
                                    ...
                                    System.out.print("Ingreso numeros mayores y menores a 10");
                                }
                            } else {
...
/*25. Introducir tantos números que hay entre el 1 al 100.excepto los multiplos de 2. */
    ...
    static int ejercicio31(int numero) {
        int aux;
        if (numero == 2) {
            return 1;
        }
        if (numero > 0) {
            return ejercicio31(numero - 1) + ejercicio31(numero - 2);
        } else {
            return 1;
        }
    }
